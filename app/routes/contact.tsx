    ...
    <div className="bg-gray-50 min-h-screen py-16">
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="text-center mb-12">
           <h1 className="text-3xl md:text-5xl font-black text-gray-800 mb-4">Contact <span className="text-[#2c9cb4]">Us</span></h1>
          ...
          <div className="bg-white border border-gray-200 shadow-sm rounded-lg p-8">
            ...
            <div className="space-y-8">
              <div className="flex items-start gap-4">
                <div className="mt-1 w-10 h-10 bg-[#2c9cb4]/10 text-[#2c9cb4] rounded-full flex items-center justify-center shrink-0">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="16" x="2" y="4" rx="2"/><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/></svg>
                </div>
                <div>
                  <h3 className="text-gray-800 font-bold mb-1">Email Support</h3>
                  <a href="mailto:support@dealsrky.com" className="text-[#2c9cb4] hover:text-[#248196] transition-colors font-medium">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="tel:+1234567890" className="text-[#2c9cb4] hover:text-[#248196] transition-colors font-medium">
                    +1 (234) 567-890
                  </a>
            ...
            <form className="space-y-5" action="mailto:support@dealsrky.com" method="POST" encType="text/plain">
              <div>
                ...
                <input 
                  ...
                  id="name" 
                  name="name"
                  className="w-full bg-gray-50 border border-gray-200 rounded-md px-4 py-3 text-gray-800 focus:outline-none focus:border-[#2c9cb4] focus:ring-1 focus:ring-[#2c9cb4] transition-all"
              ...
              <div>
                ...
                <textarea 
                  ...
                  name="message"
                  rows={5}
                  className="w-full bg-gray-50 border border-gray-200 rounded-md px-4 py-3 text-gray-800 focus:outline-none focus:border-[#2c9cb4] focus:ring-1 focus:ring-[#2c9cb4] transition-all resize-none"
              ...
              <button 
                type="submit"
                className="w-full bg-[#2c9cb4] hover:bg-[#248196] text-white font-bold py-3.5 rounded-md transition-colors mt-2 shadow-sm"
              >
                Send Message
              </button>
            </form>
