            ...
            <div className="w-full md:w-1/4">
               <div className="bg-white border md:sticky md:top-24 border-gray-200 rounded-lg p-5 shadow-sm">
                  ...
                  <div className="space-y-2">
                    <a href="/deals" className="block text-sm font-bold text-[#2c9cb4] hover:text-[#248196]">» All Deals</a>
                    {data.categories.map((cat: any) => (
                      <a 
                        key={cat.slug} 
                        href={`/category/${cat.slug}`}
                        className="block text-sm text-gray-600 hover:text-[#2c9cb4] transition-colors"
                      >
                        {cat.name}
                      </a>
                    ))}
               ...
               <div className="flex justify-between items-center mb-6 bg-white border border-gray-200 p-3 rounded-lg shadow-sm">
                ...
                {data.pagination.totalPages > 1 && (
                  <div className="flex items-center justify-center gap-2 mt-10">
                    ...
                    <span className="px-4 py-2 bg-[#2c9cb4] text-white rounded shadow-sm text-sm font-bold">
